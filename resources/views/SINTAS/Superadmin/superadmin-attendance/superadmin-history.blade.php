                ...
                <div class="p-6">
                    ...
                    <form method="GET" action="{{ route('attendance.history') }}" class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div class="flex items-end gap-2">
                            ...
                            <a href="{{ route('attendance.history') }}" class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-semibold py-2 px-4 rounded-lg transition duration-300">
                                Reset
                            </a>
                        </div>
                    </form>
            ...
            <div class="bg-white/60 backdrop-blur-sm overflow-hidden shadow-lg sm:rounded-2xl border border-gray-200/50">
                <div class="p-8">
                    <div class="flex items-center justify-between mb-6">
                        <h3 class="text-xl font-semibold text-gray-900">Daftar Absensi</h3>
                        <a href="{{ route('attendance.index') }}" class="text-blue-600 hover:text-blue-800 font-semibold text-sm">
                    ...
                    @else
                        <div class="text-center py-12">
                            ...
                            <p class="mt-1 text-sm text-gray-500">Tidak ada riwayat absensi untuk filter yang dipilih.</p>
                        </div>
                    @endif
                </div>
            </div>
