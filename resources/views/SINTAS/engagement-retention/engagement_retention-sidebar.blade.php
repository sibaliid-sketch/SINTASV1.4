@php
    ...
    if (!$dept && str_contains(request()->path(), 'departments/engagement-retention')) {
        $dept = 'engagement_retention';
    }
    
    // Final fallback - always set to engagement_retention for this sidebar file
    if (!$dept) {
        $dept = 'engagement_retention';
    }
@endphp
