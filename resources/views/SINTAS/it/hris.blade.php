                    ...
                    <div id="attendance-tab" class="tab-content">
                        <div class="flex items-center mb-6">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">Data absensi karyawan departemen IT</p>
                            </div>
                        </div>
                    ...
                    <div id="izin-tab" class="tab-content hidden">
                        <div class="flex items-center mb-6">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">Permohonan izin karyawan departemen IT</p>
                            </div>
                        </div>
                    ...
                    <div id="cuti-tab" class="tab-content hidden">
                        <div class="flex items-center mb-6">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">Permohonan cuti karyawan departemen IT</p>
                            </div>
                        </div>
                    ...
                    <div id="lembur-tab" class="tab-content hidden">
                        <div class="flex items-center mb-6">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">Permohonan lembur karyawan departemen IT</p>
                            </div>
                        </div>
