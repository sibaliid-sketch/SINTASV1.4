    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('Admin Chat Console - IT Department') }}
            </h2>
            <a href="{{ route('departments.it.tools') }}#available"
                        ...
                        <div class="bg-white rounded-lg shadow-md h-96 flex flex-col">
                            ...
                            <div class="p-4 border-b border-gray-200 bg-gradient-to-r from-blue-500 to-purple-500 text-white rounded-t-lg">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-3">
                                        <h5 class="text-sm font-medium" id="chat-user-name">Select a chat</h5>
                                        <p class="text-xs opacity-75" id="chat-user-department">IT Department</p>
                                    </div>
                            ...
                            <div id="admin-chat-messages" class="flex-1 p-4 overflow-y-auto space-y-4 bg-gray-50">
                                ...
                                <div class="flex justify-start">
                                    <div class="bg-white p-3 rounded-lg shadow-sm max-w-xs">
                                        ...
                                        <div class="text-sm text-gray-800">Halo, saya butuh bantuan dengan task IT.</div>
                                    </div>
                                </div>
