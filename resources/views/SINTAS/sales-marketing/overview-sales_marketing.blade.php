<x-app-layout>
    ...
    <x-slot name="header">
        <div class="flex items-center">
            <a href="{{ route('departments.sales-marketing') }}" class="mr-4 text-gray-500 hover:text-gray-700">
            ...
            <h2 class="font-semibold text-xl bg-gradient-to-r from-green-600 to-teal-600 bg-clip-text text-transparent leading-tight">
                {{ __('Sales & Marketing Department - Overview') }}
            </h2>
        </div>
    </x-slot>
    ...
    <div class="bg-white/60 backdrop-blur-sm border-b border-gray-200/50 mb-6">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <nav class="-mb-px flex space-x-8" aria-label="Tabs">
                <a href="{{ route('departments.sales-marketing') }}" class="border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm">
                    Dashboard
                </a>
                <a href="{{ route('departments.overview.sales-marketing') }}" class="border-indigo-500 text-indigo-600 whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm" aria-current="page">
                    Overview
                </a>
            </nav>
        </div>
                ...
                <div class="p-8">
                    <div class="flex items-center mb-6">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">Comprehensive metrics and measurements for the Sales & Marketing department.</p>
                        </div>
                    </div>
                    ...
                    <div class="bg-gradient-to-r from-green-50 to-green-100 rounded-xl p-6 border border-green-200">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-2xl font-bold text-green-900">{{ $metrics['team_members'] }}</p>
                            </div>
