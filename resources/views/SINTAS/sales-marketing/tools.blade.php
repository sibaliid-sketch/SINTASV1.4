<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl bg-gradient-to-r from-indigo-600 to-blue-600 bg-clip-text text-transparent leading-tight">
            {{ __('SINTAS - Tools (Sales & Marketing)') }}
        </h2>
    </x-slot>
                ...
                <div class="p-6">
                    <div id="overview-tab" class="tab-content">
                        <div class="flex items-center mb-6">
                            ...
                            <div>
                                <h3 class="text-2xl font-semibold text-gray-900 mb-2">Sales & Marketing Tools Overview</h3>
                                <p class="text-gray-600">Comprehensive collection of tools for sales and marketing operations.</p>
                            </div>
                        </div>
                        <p class="text-lg text-gray-700 leading-relaxed mb-6">
                            The Sales & Marketing department provides tools for CRM, campaign management, and analytics.
                        </p>
                    </div>

                    <div id="available-tab" class="tab-content hidden">
                        <h3 class="text-2xl font-semibold text-gray-900 mb-6">Available Tools</h3>
                        <p>CRM Dashboard, Marketing Campaign Manager, Lead Generation System, Sales Analytics Dashboard.</p>
                    </div>
                    ...
                    <div id="support-tab" class="tab-content hidden">
                        ...
                        <p>Contact sales.marketing.helpdesk@company.com</p>
                    </div>
                </div>
            </div>
        </div>
