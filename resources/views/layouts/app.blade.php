...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-display antialiased bg-gradient-to-br from-slate-50 via-white to-gray-100 min-h-screen">
        <div class="min-h-screen">
            ...
            <!-- Department Sidebar is included in each department dashboard -->
        ...
        <!-- Footer -->
        <footer class="bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white mt-16 relative overflow-hidden">
            @if(request()->routeIs('sintas') || request()->routeIs('departments.*') || request()->routeIs('simy') || request()->routeIs('sitra'))
                <!-- Simplified Footer for SINTAS, SIMY, SITRA -->
                <div class="py-8 relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="text-center">
                        <p class="text-gray-400 font-candara text-sm">&copy; 2024 PT. Siap Belajar Indonesia (Sibali.id). All rights reserved.</p>
                        <div class="flex justify-center space-x-4 mt-2 text-xs font-candara">
            ...
            @else
                ...
                <div class="py-12 relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
