<x-app-layout>
    ...
    <x-slot name="header">
        <div class="flex items-center">
            <a href="{{ route('departments.it') }}" class="mr-4 text-gray-500 hover:text-gray-700">
    ...
    <div class="bg-white/60 backdrop-blur-sm border-b border-gray-200/50 mb-6">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <nav class="-mb-px flex space-x-8" aria-label="Tabs">
                <a href="{{ route('departments.it') }}" class="border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm">
                    Dashboard
                </a>
                <a href="{{ route('departments.overview.it') }}" class="border-indigo-500 text-indigo-600 whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm" aria-current="page">
                    Overview
                </a>
            </nav>
        </div>
                ...
                <div class="p-8">
                    <div class="flex items-center mb-6">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">Comprehensive metrics and measurements for the IT department.</p>
                        </div>
                    </div>
