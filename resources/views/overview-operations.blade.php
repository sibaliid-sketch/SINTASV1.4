    ...
    <x-slot name="header">
        <div class="flex items-center justify-between w-full">
            <div class="flex items-center">
                <a href="{{ route('departments.operations') }}" class="mr-4 text-gray-500 hover:text-gray-700">
                ...
                <h2 class="font-semibold text-xl bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent leading-tight">
                    {{ __('Operations Department - Overview') }}
                </h2>
            </div>
            <div class="flex items-center space-x-4">
                <a href="{{ route('admin.chat') }}" class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-blue-500 to-purple-500 border border-transparent rounded-lg text-sm font-medium text-white hover:from-blue-600 hover:to-purple-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all duration-200 shadow-lg hover:shadow-xl">
    ...
    <div class="bg-white/60 backdrop-blur-sm border-b border-gray-200/50 mb-6">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <nav class="-mb-px flex space-x-8" aria-label="Tabs">
                <a href="{{ route('departments.operations') }}" class="border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm">
                    Dashboard
                </a>
                <a href="{{ route('departments.overview.operations') }}" class="border-indigo-500 text-indigo-600 whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm" aria-current="page">
                    Overview
                </a>
            </nav>
        </div>
                ...
                <div class="p-8">
                    <div class="flex items-center mb-6">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">Comprehensive metrics and measurements for the Operations department.</p>
                        </div>
                    </div>
                ...
                <div class="p-8">
                    ...
                    <div class="bg-gradient-to-r from-blue-50 to-blue-100 rounded-xl p-6 border border-blue-200">
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="text-sm font-medium text-blue-600">Team Members</p>
                                <p class="text-2xl font-bold text-blue-900">{{ $metrics['team_members'] }}</p>
                            </div>
