<x-app-layout>
    ...
    <x-slot name="header">
        <div class="flex items-center">
            <a href="{{ route('departments.retention') }}" class="mr-4 text-gray-500 hover:text-gray-700">
    ...
    <div class="bg-white/60 backdrop-blur-sm border-b border-gray-200/50 mb-6">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <nav class="-mb-px flex space-x-8" aria-label="Tabs">
                <a href="{{ route('departments.retention') }}" class="border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm">
                    Dashboard
                </a>
                <a href="{{ route('departments.overview.retention') }}" class="border-indigo-500 text-indigo-600 whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm" aria-current="page">
                    Overview
                </a>
            </nav>
        </div>
            ...
            <div class="bg-white/60 backdrop-blur-sm overflow-hidden shadow-lg sm:rounded-2xl border border-gray-200/50 mb-8">
                <div class="p-8">
                    <div class="flex items-center mb-6">
                        ...
                        <div>
                            <h3 class="text-2xl font-semibold text-gray-900 mb-2">Retention Department Overview</h3>
                            <p class="text-gray-600">Comprehensive metrics and measurements for the Retention department.</p>
                        </div>
                    </div>
                ...
                <div class="p-8">
                    ...
                    <div class="space-y-4">
                        <div class="flex justify-between items-center">
                            ...
                            <span class="font-semibold text-gray-900">{{ $metrics['team_members'] }}</span>
                        </div>
                        <div class="flex justify-between items-center">
                        ...
                        <div class="flex justify-between items-center">
                            <span class="text-gray-600">Avg. Retention Time</span>
                            <span class="font-semibold text-gray-900">18 months</span>
                        </div>
                    </div>
                </div>
            </div>
