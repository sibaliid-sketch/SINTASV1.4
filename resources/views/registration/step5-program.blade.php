        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                <div class="flex items-center justify-between mb-2">
                    <div class="flex-1 h-2 bg-gradient-to-r from-primary-600 to-secondary-600 rounded-full" style="width: 50%"></div>
                    <div class="flex-1 ml-2 h-2 bg-gray-300 rounded-full" style="width: 50%"></div>
                </div>
                <div class="text-right text-sm font-semibold text-gray-600">Step 5 dari 10</div>
            </div>

            <div class="bg-white/80 backdrop-blur-md overflow-hidden shadow-lg border border-gray-200/50 sm:rounded-2xl">
                <div class="p-6">
                    <h3 class="text-2xl font-bold mb-2 text-gray-900 bg-gradient-to-r from-primary-600 to-secondary-600 bg-clip-text text-transparent">Pilih Program {{ $serviceType }}</h3>
                    <p class="text-gray-600 mb-8">Pilih program pembelajaran {{ $serviceType }} yang sesuai dengan kebutuhan Anda untuk tingkat {{ $educationLevel }}</p>
                    ...
                    <form method="POST" action="{{ route('registration.step5-submit') }}" class="space-y-6">
                        ...
                        @if($programs->isEmpty())
                            <div class="text-center py-8">
                                <p class="text-gray-600 dark:text-gray-400">Tidak ada program tersedia untuk level pendidikan dan layanan ini</p>
                            </div>
                        @else
                            <div class="space-y-4">
