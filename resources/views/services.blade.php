kembalika<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>Services - Sibali.id</title>
...
<body class="font-display antialiased bg-gradient-to-br from-slate-50 via-white to-gray-100 min-h-screen">
    ...
    <main class="py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <h2 class="text-4xl font-serif font-bold bg-gradient-to-r from-gray-900 to-gray-600 bg-clip-text text-transparent mb-4">Layanan Kami</h2>
                <div class="w-24 h-1 bg-gradient-to-r from-blue-500 to-purple-500 mx-auto rounded-full"></div>
            </div>

            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20">
                <div class="bg-white/60 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-gray-200/50 hover:shadow-xl transition-shadow duration-300">
                    ...
                    <h3 class="text-xl font-semibold mb-4 text-gray-900">Bimbingan Belajar</h3>
                    <p class="text-base text-gray-700 leading-relaxed mb-6">Program bimbingan belajar intensif untuk semua jenjang pendidikan, dari SD hingga SMA. Dengan pendekatan personal dan materi yang disesuaikan dengan kurikulum nasional.</p>
                    <div class="space-y-3 mb-6">
                        <div class="flex items-center space-x-3">
                            <div class="w-2 h-2 bg-blue-500 rounded-full"></div>
                            <span class="text-gray-600">Pendampingan akademik personal</span>
                        </div>
                        <div class="flex items-center space-x-3">
                            <div class="w-2 h-2 bg-blue-500 rounded-full"></div>
                            <span class="text-gray-600">Materi sesuai kurikulum</span>
                        </div>
                        <div class="flex items-center space-x-3">
                            <div class="w-2 h-2 bg-blue-500 rounded-full"></div>
                            <span class="text-gray-600">Evaluasi berkala</span>
                        </div>
                    </div>
                    <a href="{{ route('registration.step1') }}" class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-500 to-purple-500 text-white font-semibold rounded-xl hover:from-blue-600 hover:to-purple-600 transition-all duration-200 shadow-lg">
                        Pesan Sekarang
                ...
                <div class="bg-white/60 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-gray-200/50 hover:shadow-xl transition-shadow duration-300">
                    ...
                    <h3 class="text-xl font-semibold mb-4 text-gray-900">Kursus Bahasa Inggris</h3>
                    <p class="text-base text-gray-700 leading-relaxed mb-6">Kelas bahasa Inggris dengan metode pembelajaran modern dan pengajar profesional. Dari pemula hingga mahir, kami siap membantu Anda menguasai bahasa internasional.</p>
                    <div class="space-y-3 mb-6">
                        <div class="flex items-center space-x-3">
                            <div class="w-2 h-2 bg-green-500 rounded-full"></div>
                            <span class="text-gray-600">Pengajar bersertifikat</span>
                        </div>
                        <div class="flex items-center space-x-3">
                            <div class="w-2 h-2 bg-green-500 rounded-full"></div>
                            <span class="text-gray-600">Metode interaktif</span>
                        </div>
                        <div class="flex items-center space-x-3">
                            <div class="w-2 h-2 bg-green-500 rounded-full"></div>
                            <span class="text-gray-600">Kelas fleksibel</span>
                        </div>
                    </div>
                    <a href="{{ route('registration.step1') }}" class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-green-500 to-teal-500 text-white font-semibold rounded-xl hover:from-green-600 hover:to-teal-600 transition-all duration-200 shadow-lg">
                        Pesan Sekarang
                        <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                        </svg>
            ...
            <div class="bg-white/60 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-gray-200/50">
                <h3 class="text-xl font-semibold text-center text-gray-900 mb-6">Layanan Tambahan</h3>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div class="text-center">
                        ...
                        <h4 class="text-xl font-semibold text-gray-900 mb-2">Portal Sistem</h4>
                        <p class="text-gray-600">Akses SIMY, SITRA, dan SINTAS untuk pengalaman belajar terintegrasi.</p>
                    </div>
                    <div class="text-center">
                        ...
                        <h4 class="text-xl font-semibold text-gray-900 mb-2">Outsourcing Tenaga</h4>
                        <p class="text-gray-600">Program pelatihan kerja dan penyediaan tenaga terampil.</p>
                    </div>
                    <div class="text-center">
                        ...
                        <h4 class="text-xl font-semibold text-gray-900 mb-2">Konsultasi</h4>
                        <p class="text-gray-600">Bimbingan karir dan pengembangan diri untuk fresh graduate.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Admin Chat Window -->
    <div id="admin-chat-window" class="fixed bottom-20 right-4 w-80 h-96 bg-white rounded-lg shadow-2xl border border-gray-200 hidden z-40">
