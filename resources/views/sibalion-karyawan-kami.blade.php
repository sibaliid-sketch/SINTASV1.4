...
<head>
    ...
    <title>Sibalion! Karyawan kami! - Sibali.id</title>
...
<body class="font-display antialiased bg-gradient-to-br from-slate-50 to-gray-100 min-h-screen">
    ...
    <main class="py-16">
        ...
        <section class="relative overflow-hidden">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-16">
                    <h2 class="text-5xl font-serif font-bold bg-gradient-to-r from-gray-900 to-gray-600 bg-clip-text text-transparent mb-6 float">Sibalion! Karyawan kami!</h2>
                    <p class="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">Membangun Tim Unggul untuk Generasi Unggul</p>
                </div>
                ...
                <div class="relative mb-20">
                    <div class="bg-gradient-to-r from-blue-500 to-purple-600 rounded-3xl p-1 shadow-2xl">
                        <div class="bg-white rounded-3xl overflow-hidden">
                            <img src="https://images.unsplash.com/photo-1522202176988-66273c2fd55f?w=1200&h=600&fit=crop&crop=center" alt="Team Excellence" class="w-full h-96 object-cover">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="py-16 bg-white/50">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-16">
                    <h3 class="text-3xl font-serif font-bold text-gray-900 mb-6">Kami Adalah Tim Profesional</h3>
                    <p class="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">Di Sibali.id, kami percaya bahwa keberhasilan perusahaan ditentukan oleh kualitas karyawannya. Tim kami terdiri dari para profesional yang berdedikasi tinggi, inovatif, dan berkomitmen untuk memberikan yang terbaik bagi siswa dan masyarakat.</p>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    <div class="bg-white/60 backdrop-blur-sm rounded-3xl p-8 shadow-lg border border-gray-200/50 text-center hover:shadow-xl transition-all duration-500 hover:scale-105">
                        ...
                        <h4 class="text-xl font-serif font-semibold text-gray-900 mb-4">Inovasi & Kreativitas</h4>
                        <p class="text-gray-600 leading-relaxed">Tim kami selalu berinovasi dalam metode pembelajaran dan pendekatan pendidikan untuk memberikan pengalaman terbaik.</p>
                    </div>
                    ...
                    <div class="bg-white/60 backdrop-blur-sm rounded-3xl p-8 shadow-lg border border-gray-200/50 text-center hover:shadow-xl transition-all duration-500 hover:scale-105">
                        ...
                        <h4 class="text-xl font-serif font-semibold text-gray-900 mb-4">Kolaborasi Tim</h4>
                        <p class="text-gray-600 leading-relaxed">Kami bekerja sebagai tim yang solid, saling mendukung untuk mencapai tujuan bersama dalam membangun pendidikan berkualitas.</p>
                    </div>
                    ...
                    <div class="bg-white/60 backdrop-blur-sm rounded-3xl p-8 shadow-lg border border-gray-200/50 text-center hover:shadow-xl transition-all duration-500 hover:scale-105">
                        ...
                        <h4 class="text-xl font-serif font-semibold text-gray-900 mb-4">Dedikasi & Komitmen</h4>
                        <p class="text-gray-600 leading-relaxed">Setiap anggota tim kami memiliki dedikasi tinggi terhadap misi pendidikan dan komitmen untuk memberikan pelayanan terbaik.</p>
                    </div>
                </div>
            </div>
        </section>
    ...
    <!-- Admin Chat Window -->
    <div id="admin-chat-window" class="fixed bottom-20 right-4 w-80 h-96 bg-white rounded-lg shadow-2xl border border-gray-200 hidden z-40 flex flex-col">
