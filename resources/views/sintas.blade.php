            ...
            <div class="bg-white/60 backdrop-blur-sm overflow-hidden shadow-lg sm:rounded-2xl border border-gray-200/50 mb-8">
                <div class="p-8">
                    <div class="flex items-center mb-6">
                        ...
                        <div>
                            <h3 class="text-2xl font-semibold text-gray-900 mb-2">Selamat Datang di SINTAS</h3>
                            <p class="text-gray-600">Sistem internal untuk manajemen operasional perusahaan.</p>
                        </div>
                    </div>
                    <p class="text-lg text-gray-700 leading-relaxed mb-6">
                        SINTAS adalah platform internal yang digunakan oleh berbagai departemen untuk mengelola website, sistem SIMY, sistem SITRA, serta operasional perusahaan secara keseluruhan. Sistem ini menyediakan tools dan dashboard yang diperlukan untuk menjalankan bisnis dengan efisien.
                    </p>
                </div>
            </div>
